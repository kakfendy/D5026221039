...
<body class="bg-dark">
    ...
    <div class="jumbotron-fluid">
        <div class="row">
            ...
            <div class"col-md-12">
                <img src="bcg.jpeg" alt="Backgorund Pizza" class="img-fluid">
            </div>
        </div>
    </div>
    ...
    <div class="container mt-2">
        <div class="row">
            <div class="col-3">
                <img src="gambar1.jpg" alt="Gambar 1" width="75px" height="75px">
            </div>

            <div class="col-3">
                <img src="gambar2.jpg" alt="Gambar 2" width="75px" height="75px">
            </div>

            <div class="col-3">
                <img src="gambar3.jpg" alt="Gambar 3" width="75px" height="75px">
            </div>

            <div class="col-3">
                <img src="gambar4.jpg" alt="Gambar 4" width="75px" height="75px">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-2">
                <button class="btn btn-dark" style="border: 1px solid rgb(141, 141, 141);">
                    <img src="tomato.png" width="40px" height="40px">
                </button>
            </div>
            <div class="col-2">
                <button class="btn btn-dark"style="border: 1px solid rgb(141, 141, 141);">
                    <img src="basil.png" width="40px" height="40px">
                </button>
            </div>
            <div class="col-2">
                <button class="btn btn-dark"style="border: 1px solid rgb(141, 141, 141);">
                    <img src="onion.png" width="40px" height="40px">
                </button>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-2 mt-4">
                <button class="btn btn-secondary" style="border: 1px solid rgb(141, 141, 141); height: 100%;">
                    <img src="bag.png" width="40px" height="40px">
                </button>
            </div>
